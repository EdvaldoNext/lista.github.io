...
function adicionarProduto() {
  const produtoInput = document.getElementById('inputProduto');
  const quantidadeInput = document.getElementById('inputQuantidade');
...
function renderizarCompras() {
  ...
  compras.forEach((compra, index) => {
      ...
      item.textContent = `${compra.quantidade} x ${compra.produto} - R$ ${compra.valor}`;
      ...
      total += parseFloat(compra.valor) * parseInt(compra.quantidade);
  });
